...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_FILES['Gambar']['size'] > $max_size) {
        ...
        echo '<script>alert("Tipe file tidak diizinkan. Hanya PNG, JPG, dan JPEG yang diperbolehkan."); window.location.href = "pendataanbarang.php";</script>';
        exit();
    } elseif ($harga < 0 || $stok < 0) {
        echo '<script>alert("Harga dan Stok tidak boleh kurang dari 0."); window.location.href = "pendataanbarang.php";</script>';
        exit();
    } else {
