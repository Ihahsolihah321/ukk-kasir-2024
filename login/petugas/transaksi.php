                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="cekpelanggan.php">
                            <div class="form-group">
                                ...
                                // Menampilkan opsi select untuk setiap pelanggan
                            ...
                            <button type="submit" class="btn btn-primary" name="login">Cek Pelanggan</button>
                        </form>
                        <!-- End Formulir Login -->
                    </div>
                </div>
